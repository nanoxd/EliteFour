...
class Test2019: XCTestCase {
    ...
    func testDay7() {
        ...
        measure {
            ...
            XCTAssertEqual(p1, "422858")
            XCTAssertEqual(p2, "14897241")
        }
    }
    ...
    func testDay8() {
        ...
        measure {
            ...
            XCTAssertEqual(p1, "1548")
            XCTAssertEqual(p2, message)
        }
    }
    ...
    func test_day8Part1_examples() {
        ...
        let layers1 = day.imageData(
            from: [1, 2, 3, 4, 5, 6, 7, 8, 9, 0, 1, 2],
            width: 3,
            height: 2
        )
        XCTAssertEqual(layers1[0].data, [[1, 2, 3], [4, 5, 6]])
        XCTAssertEqual(layers1[1].data, [[7, 8, 9], [0, 1, 2]])
    }
    ...
    func testDay9() {
        ...
        measure {
            ...
            XCTAssertEqual(p1, "4080871669")
            XCTAssertEqual(p2, "75202")
        }
    }
